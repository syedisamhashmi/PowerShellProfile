...
if (
  ...
  )
  {
    ...
    if ($toolInstallDecision -eq 0) {
      ...
      Write-Host "Installing dotnet version 6.0.422..."
      ...
      Write-Host "Done installing dotnet version 6.0.422."
      Write-Host "To install other dotnet versions, run ``install_dotnet_version``"
    }
